...
//     });
//
//     it('should Not give validation error if end date is equal to start date', function (done) {
//
//       var now = new Date();
//       testEvent.start = now;
...
//           expect(err.errors).to.exist;
//           expect(err.errors['end']).to.exist;
//           expect(err.errors['end'].message).to.equal('End date must be equal or greater than start date');
//         })
//         .then(function () {
//           done();
//         }, done);
...
//           expect(event.label).to.equal(newData.label);
//         })
//         .then(function () {
//           done();
//         }, done);
