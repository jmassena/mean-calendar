  ...
  describe('Existing', function () {
    ...
    describe('PUT /calendars/:calendarId', function () {
      it('should update a calendar', function (done) {
        ...
        testCalendar.showEvents = false;
        testCalendar.color = '#ccccee';
          ...
          .end(function (err, res) {
            ...
            request(app)
              ...
              .end(function (err, res) {
                ...
                expect(res.body.showEvents).to.equal(testCalendar.showEvents);
                expect(res.body.color).to.equal(testCalendar.color);
