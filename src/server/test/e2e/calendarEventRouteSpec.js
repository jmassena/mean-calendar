    ...
    it('should create an event', function (done) {
      ...
      request(app)
        ...
        .end(function (err, res) {
          ...
          expect(res.header.location).to.equal(eventUrl.get(testCalendar.id, res.body
            ._id));
    ...
    describe('GET /calendars', function () {
      ...
      it('should get all 6 calendar events', function (done) {
        ...
        request(app)
          ...
          .end(function (err, res) {
            ...
            expect(res.body.events.length).to.equal(6);
            done();
          });
      });
      ...
      it('should get 4 calendars within specified range', function (done) {
        ...
        request(app)
          ...
          .end(function (err, res) {
            expect(res.status).to.equal(200);
            expect(res.body.events.length).to.equal(4);
            done();
          });
      });
